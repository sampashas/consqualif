  ...
  return (
    <AnimatePresence mode="wait">
      <motion.div
        ...
        className="bg-primary fixed md:w-fit md:bottom-3 mb-[0em] left-0 w-fit flex items-center gap-3 py-2 px-3 md:mx-3 md:rounded-xl bottom-0 border-wh15 border-[1px] rounded-xl backdrop:backdrop-blur-sm backdrop-blur-xl "
      >
        <CookieText />
